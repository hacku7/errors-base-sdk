...
func TestCause(t *testing.T) {
	...
	tests := []struct {
		...
		err:  x, // return from errors-base-sdk.New
		want: x,
	}, {
...
// errors-base-sdk.New, etc values are not expected to be compared by value
// but the change in errors-base-sdk#27 made them incomparable. Assert that
// various kinds of errors-base-sdk have a functional equality operator, even
...
func TestParseCoder(t *testing.T) {
	tests := []struct {
		...
		{fmt.Errorf("yes error"), 500, "An internal server error occurred", 1, "http://github.com/hacku7/errors-base-sdk/README.md"},
		{WithCode(unknownCoder.Code(), "internal error message"), 500, "An internal server error occurred", 1, "http://github.com/hacku7/errors-base-sdk/README.md"},
	}
